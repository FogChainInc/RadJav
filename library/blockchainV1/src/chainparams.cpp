...
public:
    CMainParams() {
		...
		consensus.nPowTargetTimespan = 5 * 60; // 5 minutes set this to 4 days eventually
        ...
        checkpointData = CCheckpointData {
            ...
            ( 0, uint256S("0x0000000032d2713b6088fd4f564fe55f771d854c4587448bc6fb11abaf7c6bd7"))
        };
